...
let global_var = {
    ...
    async init(cookie, num) {
        if (cookie) {
            ...
            const commentDisabledAccounts = this.get('commentDisabledAccounts') instanceof Set
                ? this.get('commentDisabledAccounts')
                : new Set();
            this.set('commentDisabledAccounts', commentDisabledAccounts);
            this.set('accountNum', String(num));
            this.set('commentDisabled', commentDisabledAccounts.has(String(num)));
