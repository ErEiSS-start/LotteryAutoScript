...
const config = {
    ...
    /**
     * 多服务器分片时，各实例首个本地帐号统一复用哪个config_N作为采集配置
     */
    ...
    ai_judge_parm: {
        /** 开启判断时只直连第一个可用provider，不使用缓存或故障切换。 */
        providers: [],
        /** 兼容旧版单供应商配置 */
        url: '',
        body: {},
    ...
    /**
     * - 待领取中奖私信的重复提醒间隔
     * - 单位毫秒；默认每2小时提醒一次，直到帐号在对应私信会话中回复
     */
    ...
    /**
     * 同一账号在一次任务中至少有多少个不同UP返回22015，才推送账号级关注受限告警
     * 单个UP失败通常是目标侧限制，最小值固定为2
     */
    follow_restriction_distinct_up_threshold: 2,
